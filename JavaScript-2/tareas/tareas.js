...
function fizzBuzz(numero) { 
  ...
  // Si "numero" es divisible entre 3 y 5 (ambos), devuelve "fizzbuzz"  NO RETORNA ESTE
...
function operadoresLogicos(num1, num2, num3) {
  //La función recibe tres números distintos.   NO RETORNA EL ERROR-0
...
function esPrimo(numero) {
  // Devuelve "true" si "numero" es primo  NO ME SALIO
